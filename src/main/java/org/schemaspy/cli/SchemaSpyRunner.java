...
public class SchemaSpyRunner {
    ...
    public void run(String... args) {
        // CB - mavenization
        SchemaSpyConfiguration schemaSpyConfiguration = new SchemaSpyConfiguration();
        arguments = new CommandLineArguments();
        commandLineArgumentParser = schemaSpyConfiguration.commandLineArgumentParser(args, arguments);
        SqlService sqlService = new SqlService();
        TableService tableService = new TableService(sqlService, arguments);
        ViewService viewService = new ViewService(sqlService);
        DatabaseService databaseService = new DatabaseService(tableService, viewService, sqlService);
        analyzer = new SchemaAnalyzer(sqlService, databaseService, arguments);
